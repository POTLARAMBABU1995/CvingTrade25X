PROMPT Creating staging table for Restaurants Sector
...
USING (
  SELECT 'RESTAURANTS' AS SECTOR_CODE, 'Restaurants' AS SECTOR_NAME, 'NIFTY_RESTAURANTS' AS INDEX_CODE, 60 AS DISPLAY_ORDER FROM DUAL
) src
