PROMPT Resolving conflicts for Tourism & Travel Sector symbols
SET DEFINE OFF;
...
DECLARE
    ...
    END;
BEGIN
    reclassify_symbol('ECOSMOBLTY', 'NSE_NIFTY_ROAD_RAIL_TRANSPORT_STAGING');
    reclassify_symbol('BLS', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('IRCTC', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('TBOTEK', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
END;
/
