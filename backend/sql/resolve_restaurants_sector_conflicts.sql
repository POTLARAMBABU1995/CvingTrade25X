PROMPT Resolving conflicts for Restaurants Sector symbols
SET DEFINE OFF;
...
DECLARE
    ...
    END;
BEGIN
    reclassify_symbol('DEVYANI', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('JUBLFOOD', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('SAPPHIRE', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('TRAVELFOOD', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('WESTLIFE', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
END;
/
