PROMPT Resolving conflicts for Education & E-Learning Sector symbols
SET DEFINE OFF;
...
DECLARE
    ...
    END;
BEGIN
    reclassify_symbol('APTECHT', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('JARO', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
    reclassify_symbol('PWL', 'NSE_NIFTY_CONSUMER_SERVICES_STAGING');
END;
/
